...
export const TRAINERS = [
  ...
  },
  {
    ...
    rating: 4.9,
    reviewCount: 203,
    intro: '스쿼트, 데드리프트 등 복합 운동 코칭. 안전한 자세로 근력 향상을 돕습니다.',
    introLong: '근력 트레이닝과 복합 운동 코칭 전문입니다. 12년간 스쿼트, 데드리프트, 벤치프레스 등 기초 복합 운동의 안전한 자세와 프로그레시브 오버로드를 지도해왔습니다.',
    trainingAreas: ['근력 강화', '자세 교정', '복합 운동', '파워리프팅'],
    certifications: ['NSCA-CSCS', 'NASM CPT', '올림픽 리프팅 지도자'],
    programs: ['근력 강화 프로그램', '입문자 맞춤 프로그램', '파워리프팅 기초'],
    pricePerHour: 65000,
    image: null,
  },
  {
  ...
  },
  {
    ...
    rating: 4.9,
    reviewCount: 178,
    intro: '여성 다이어트와 호르몬 밸런스. 개인 차이를 고려한 맞춤 프로그램을 제공합니다.',
    introLong: '여성 다이어트와 호르몬 밸런스에 특화되어 있습니다. 9년간 여성 회원의 체질·생활 패턴·호르몬 주기를 고려한 맞춤 프로그램으로 많은 성과를 만들어왔습니다.',
    trainingAreas: ['다이어트', '바디 셰이핑', '호르몬 밸런스', '체형 교정'],
    certifications: ['스포츠영양사', 'NASM WLS', '여성 건강 트레이닝 전문가'],
    programs: ['다이어트 집중 프로그램', '바디 셰이핑 프로그램', '호르몬 밸런스 코칭'],
    pricePerHour: 62000,
    image: null,
  },
  {
  ...
  },
  {
    ...
    rating: 4.5,
    reviewCount: 41,
    intro: '건강한 식습관과 유산소 결합. 부담 없이 시작할 수 있는 다이어트 플랜을 제안합니다.',
    introLong: '건강한 식습관과 유산소를 결합한 다이어트를 지도합니다. 3년간 부담 없이 시작할 수 있는 플랜으로 초보 회원들의 첫 다이어트 성공을 도왔습니다.',
  ...
  },
  {
    ...
    rating: 5.0,
    reviewCount: 287,
    intro: '바디빌딩·피트니스 대회 준비 코치. 극한의 목표까지 함께 달성합니다.',
    introLong: '바디빌딩과 피트니스 대회 준비 코치입니다. 15년간 아마추어부터 프로까지 다양한 대회 준비를 지도해왔으며, 근비대·커팅·피크 컨디셔닝까지 한 번에 설계합니다.',
    trainingAreas: ['근력 강화', '체형 교정', '바디빌딩', '대회 준비'],
    certifications: ['IFBB Pro', 'NSCA-CSCS', '스포츠영양사'],
    programs: ['근력 강화 프로그램', '바디빌딩 대회 준비', '커팅·피크 프로그램'],
    pricePerHour: 75000,
    image: null,
  },
];
