<template>
  <div class="min-h-screen bg-[#0a0a0a] flex items-center justify-center px-4">
    <div class="w-full max-w-sm">
      ...
      <div class="bg-[#141414] rounded-2xl border border-white/10 p-6">
        <div class="space-y-4">
          <div>
            ...
            <input
              ...
              class="w-full px-4 py-3 rounded-xl border border-white/10 bg-[#1e1e1e] focus:ring-2 focus:ring-primary-500 outline-none text-white placeholder-slate-500"
              @keyup.enter="onLogin"
            />
          </div>
      ...
      <div class="mt-4 p-3 bg-amber-950/30 border border-amber-700/40 rounded-xl text-amber-400 text-sm text-center">
        💡 데모 비밀번호: admin1234
      </div>
    </div>
  </div>
