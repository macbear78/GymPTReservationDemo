...
import { menuData, navItems } from "../data/menuData.js";
        ...
        <div class="header__mega-inner">
          ...
          <div class="header__mega-grid">
            ...
            >
              ...
              <p class="header__mega-card-desc">
                {{ cat.description }}
              </p>
            </router-link>
          </div>
            ...
            >
              ...
              <template v-else>
                ...
                >
                  ...
                  <span
                    class="header__mobile-chevron"
                    :class="{ 'is-open': mobileExpandedKey === item.key }"
                  >
                    +
                  </span>
                </button>
                ...
                <Transition name="accordion">
                  <div
                    v-if="mobileExpandedKey === item.key"
                    class="header__mobile-drop"
                  >
                    <p class="header__mobile-desc">
                      {{ menuData[item.key]?.description }}
                    </p>
...
.header__mobile-chevron.is-open {
